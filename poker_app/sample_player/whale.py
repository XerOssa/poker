...
class Whale(BasePokerPlayer):  # Do not forget to make parent class as "BasePokerPlayer"


    def declare_action(self, valid_actions, hole_card, round_state):
        
        position = ""
        player_index = next((i for i, seat in enumerate(round_state["seats"]) if seat['name'] == "Whale"), None)
        ...
        if action == "raise":
            ...
            if action_info:
                amount = action_info["amount"]
        print("Whale zagrał:", action, amount)
