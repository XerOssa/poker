...
class DataEncoder:
  ...
  @classmethod
  def encode_valid_actions(cls, call_amount, min_bet_amount, max_bet_amount, players):
    # Sprawdź, czy gracz może wykonać akcję "check"
    can_check = ActionChecker.agree_amount(players) == 0
